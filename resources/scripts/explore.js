...
var createFovoriteDataTable = function (obj) {
    ...
    columnss.push({
        "data": "manage",
        "render": function (data, type, row, meta) {
            return "<i class='fa fa-pencil midtitle2 add-pointer mr-2' style='color: green' onClick='goToSqlSearchForEdit(`" + row[0] + "`)'></i>  <i class='fa fa-times text-red midtitle2 add-pointer' onClick='changeStarFavor(`" + row[0] + "`, true)'> </i>"
        }
    })
    if (obj.length > 0) {
...
var createLiveLinkDataTable = function (obj) {
    ...
    recentColumns.push({
        "data": "manage",
        "render": function (data, type, row, meta) {
            return "<i class='fa fa-pencil midtitle2 add-pointer mr-2' style='color: green' onClick='goToSqlSearchForEdit(`" + row[0] + "`)'></i>  <i class='fa fa-trash  midtitle2' data-toggle='modal' data-target='#deleteLivelinkModal' data-id='" + row[0] + "'> </i>"
        },
    })
